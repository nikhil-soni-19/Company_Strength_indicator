...
# Run the pipeline against a single ticker
python main.py score AAPL

# Ask the agent a natural-language question (requires OPENAI_API_KEY)
python main.py ask "How liquid is GME for a 5% position?"
```
