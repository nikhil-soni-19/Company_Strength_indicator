...
Passing any other dimension will crash with psycopg2.errors.DataException:
"different vector dimensions". The existing all-MiniLM-L6-v2 (384-dim,
padded to 1536-dim in the old stub) is intentionally NOT used here.
...
def embed_query(text: str) -> List[float]:
    ...
    model = _get_model()
    # BGE-large produces 1024-dim; normalize_embeddings=True gives unit vectors
...
def vec_literal(v: List[float]) -> str:
    """Format a vector list as the Postgres literal '[x,y,z,...]'."""
